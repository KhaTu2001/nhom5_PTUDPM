...
Route::post('/forgot-password', [LoginController::class, 'requestForgotPassword'])->name('request-forgot-password');
Route::get('reset-password/{token}', [LoginController::class, 'showResetPasswordForm'])->name('reset_password.get');
Route::post('reset-password', [LoginController::class, 'submitResetPasswordForm'])->name('reset_password.post');
