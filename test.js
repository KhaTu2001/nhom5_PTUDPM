...
function addMoreQuestion() {
  ...
  var original = document.getElementById(`original`); // Lấy phần tử cần sao chép
  original.setAttribute("class", "del-question");
  // var questCon = document.getElementById("more-option");
  // questCon.setAttribute(`id`, `option-${defaultId}`);
  // document.getElementById("option-row").setAttribute(`class`, `chose-${defaultId}`);
  // document.getElementById("another-option").setAttribute(`id`, `another-option-${defaultId}`);
  // document.getElementById("add-option-click").setAttribute(`id`, `add-option-click-${defaultId}`);
	var clone = original.cloneNode(true); // Tạo bản sao của phần tử đó

  document.getElementById("more-question").appendChild(clone);
  questionCount++;
  defaultId++;
}
...
function addMoreOption(defaultId) {
  ...
  var questionDiv = document.getElementById(`option-${defaultId}`);
